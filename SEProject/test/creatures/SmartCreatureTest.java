...
public class SmartCreatureTest {
	...
	public void testEmerginBehavior() throws Exception {
		SmartCreature main = new SmartCreature(environment, new Point2D.Double(0, 0), 6.0, toRadians(0), Color.RED);
		...
		assertEquals(Math.max(Math.min((10.0+6.0)/2, main.MAX_SPEED),main.MIN_SPEED), main.getSpeed(), .01);
